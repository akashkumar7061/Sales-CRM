...
import { Building2, Shield, User, ArrowRight, AlertCircle, Sun, Moon } from 'lucide-react';
...
export const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await login(emailTrimmed, password, activeTab);
      if (res.success) {
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type="email"
                  required
                  placeholder={activeTab === 'admin' ? 'admin@crm.com' : 'employee@company.com'}
                  value={email}
