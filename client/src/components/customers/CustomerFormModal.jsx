...
export const CustomerFormModal = ({ isOpen, onClose, customerToEdit, onSuccess }) => {
  ...
  const validate = () => {
    ...
    if (!formData.location.trim()) errs.location = 'Location / Area is required';
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                type="text"
                placeholder="e.g. Cyber City, Phase 3"
                value={formData.location}
                onChange={(e) => setFormData({ ...formData, location: e.target.value })}
                className={`w-full rounded-lg border bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none ${
                  errors.location ? 'border-rose-500' : 'border-slate-300 dark:border-slate-700 focus:border-indigo-500'
                }`}
                required
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none ${
                  errors.city ? 'border-rose-500' : 'border-slate-300 dark:border-slate-700 focus:border-indigo-500'
                }`}
                required
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border bg-white dark:bg-slate-950 px-3 py-2 text-sm text-slate-900 dark:text-white focus:outline-none ${
                  errors.state ? 'border-rose-500' : 'border-slate-300 dark:border-slate-700 focus:border-indigo-500'
                }`}
                required
              />
